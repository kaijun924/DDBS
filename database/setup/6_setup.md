...

{
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "exemplar": false,
          "expr": " mongodb_mongod_db_objects_total{env=\"$env\", instance=\"router\"}",
          "hide": false,
          "instant": false,
        ...
        },
        {
          ...
          "editorMode": "code",
          "expr": " mongodb_mongod_db_objects_total{env=\"$env\", instance=\"dbms1\"}",
          "hide": false,
          "instant": false,
          "legendFormat": "{{database}}",
          "range": true,
        ...
        },
        {
          ...
          "editorMode": "code",
          "expr": " mongodb_mongod_db_objects_total{env=\"$env\", instance=\"dbms2\"}",
          "hide": false,
          "instant": false,
          "legendFormat": "{{database}}",
          "range": true,
  ...
  "templating": {
    "list": [
      ...
      {
        "current": {
          "text": "mongodb_configsvr",
          "value": "mongodb_configsvr"
        },
        "datasource": {
          "type": "prometheus",
          "uid": "fe79onqwdoy68a"
